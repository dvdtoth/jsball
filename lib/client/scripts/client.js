...
var Game = function () {
    ...
    this.movePlayer = function () {
        this.localPlayer.playerBody.setAttributeNS(null, "cx", this.localPlayer.x);
        this.localPlayer.playerBody.setAttributeNS(null, "cy", this.localPlayer.y);
    };


    this.playerKick = function (kick) {
        kick ? this.playerBody.setAttributeNS(null, "stroke", "white") : this.playerBody.setAttributeNS(null, "stroke", "black");
    }
...
setInterval(function () {
    try {
        ...
        keyPressed[32] ? game.localPlayer.playerBody.setAttributeNS(null, "stroke", "white") : game.localPlayer.playerBody.setAttributeNS(null, "stroke", "black");
