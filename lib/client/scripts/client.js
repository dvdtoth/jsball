...
var Game = function () {
    ...
    this.playerKick = function (id, kick) {
        ...
        kick ? this.field.players[id].playerBody.setAttributeNS(null, "stroke", "white") : this.field.players[id].playerBody.setAttributeNS(null, "stroke", "black");
    }
...
setInterval(function () {
    try {
        ...
        keyPressed[32] ? game.localPlayer.kick = true : game.localPlayer.kick = false;
